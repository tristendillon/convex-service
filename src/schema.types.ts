...
type Add1<N extends number> = N extends 0 ? 1 : N extends 1 ? 2 : N extends 2 ? 3 : 4
...
type ValidateState = Partial<{
  schema: z.ZodTypeAny
  validationFn: (ctx: GenericQueryCtx<GenericDataModel>) => Promise<void> | void
}>
