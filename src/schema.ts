...
import {
  ConvexService as IConvexService,
  BuilderState,
...
> {
  ...
  validate(
    schemaOrFn?:
      | z.ZodTypeAny
      | ((ctx: GenericQueryCtx<GenericDataModel>) => Promise<void> | void)
  ): this {
...
export function defineService<ZodSchema extends z.ZodTypeAny>(
  zodSchema: ZodSchema
): IConvexService<ZodSchema> {
  return new ConvexService(zodSchema) as unknown as IConvexService<ZodSchema>
}
